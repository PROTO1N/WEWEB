...
<body>
    ...
    <div class="cols__container">
      <div class="left__col">
        <div class="img__container">
          <label for="upload-profile-picture">
            <img id="profileImage" src="img/user.jpeg" alt="Anna Smith" />
          </label>
      ...
      <div class="right__col">
        ...
        <div class="photos">
          ...
          <input type="file" id="upload-photo-1" style="display: none;" />

          <label for="upload-photo-2">
            <img src="img/img_2.avif" alt="Photo" />
          </label>
          <input type="file" id="upload-photo-2" style="display: none;" />

          <label for="upload-photo-3">
            <img src="img/img_3.avif" alt="Photo" />
          </label>
          <input type="file" id="upload-photo-3" style="display: none;" />

          <label for="upload-photo-4">
            <img src="img/img_4.avif" alt="Photo" />
          </label>
          <input type="file" id="upload-photo-4" style="display: none;" />

          <label for="upload-photo-5">
            <img src="img/img_5.avif" alt="Photo" />
          </label>
          <input type="file" id="upload-photo-5" style="display: none;" />

          <label for="upload-photo-6">
            <img src="img/img_6.avif" alt="Photo" />
          </label>
          <input type="file" id="upload-photo-6" style="display: none;" />
        </div>
      </div>
    </div>
  </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      var profileImageInput = document.getElementById('upload-profile-picture');
